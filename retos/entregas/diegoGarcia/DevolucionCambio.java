...
public class DevolucionCambio {
    public static void main(String [] args) {
        ...
        System.out.print("Introduzca el dinero a pagar por el cliente: ");
        ...
        if (dineroEntregado < dineroAPagar){
            ...
            numeroDeBilletes = devolucionDinero/billete500;
            resto = devolucionDinero%billete500;
            if(numeroDeBilletes>= 1){
                System.out.println((int)numeroDeBilletes +" billete(s) de 500");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" billete(s) de 200"); 
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" billete(s) de 100");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" billete(s) de 50");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" billete(s) de 20");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" billete(s) de 10");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" billete(s) de 5");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" moneda(s) de 2");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" moneda(s) de 1");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" moneda(s) de 0.5");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" moneda(s) de 0.2");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" moneda(s) de 0.1");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" moneda(s) de 0.05");
            }
            ...
            if (numeroDeBilletes>=1){
                ...
                System.out.println((int)numeroDeBilletes +" moneda(s) de 0.01");
            }
