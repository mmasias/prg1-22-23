...
public class retoWhacAMole {
  ...
  public static void simulacionposicionGolpe(){
    ...
    //  Obtener posiciones de monigotes y evitar que sean iguales
    do {
      posicionMonigote1 = 1 + (int)(Math.random() * 16);
      posicionMonigote2 = 1 + (int)(Math.random() * 16);
    } while (posicionMonigote1 == posicionMonigote2);
    
    // Si el jugador acierta, se aumentan los aciertos y se configura el array statusGolpe
