public class Moneda {
    public static void main(String[]args){
        ...
        System.out.println("De la ecuacion "+ cCuadratico +"x^2 + "+ cLineal +"x + "+ terminoIndependiente +" concluimos que su raiz positiva es igual a "+ ecuacionCuadraticaPositivos +" y que su raiz negativa es igual a "+ ecuacionCuadraticaNegativos);
        x.close();
