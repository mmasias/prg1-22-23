...
public class Adivinación {
       public static void main (String Args[] ) {
        ...
        System.out.println("Piensa un número del 1 al 99 por favor");

        MostrarTarjeta1();

        int Tarjeta1 = entrada.nextInt();

        MostrarTarjeta2();

        int Tarjeta2 = entrada.nextInt();

        MostrarTarjeta3();

        int Tarjeta3 = entrada.nextInt();

        MostrarTarjeta4();

        int Tarjeta4 = entrada.nextInt();

        MostrarTarjeta5();

        int Tarjeta5 = entrada.nextInt();

        MostrarTarjeta6();

        int Tarjeta6 = entrada.nextInt();

        MostrarTarjeta7();

        int Tarjeta7 = entrada.nextInt();

        int Númeropensado = ((Tarjeta1 * 1) + (Tarjeta2 * 2) + (Tarjeta3 * 4) + (Tarjeta4 * 8) + (Tarjeta5 * 16) + (Tarjeta6 * 32) + (Tarjeta7 * 64));
        System.out.println("Vale, el número es " + Númeropensado);
        System.out.println("He acertado ¿verdad?");
        
        entrada.close();
    }

        static void MostrarTarjeta1(){
        
            System.out.println("Está el número que has pensado en esta tarjeta? (1 para sí y 0 para no)");
        System.out.println("+---------------------------+");
        System.out.println("|       Tarjeta Nº1         |");
        System.out.println("+---------------------------+");
        ...
        static void MostrarTarjeta2(){
        
            System.out.println("Está el número que has pensado en esta tarjeta? (1 para sí y 0 para no)");
        System.out.println("+---------------------------+");
        System.out.println("|       Tarjeta Nº2         |");
        System.out.println("+---------------------------+");
        ...
        static void MostrarTarjeta3(){
        
            System.out.println("Está el número que has pensado en esta tarjeta? (1 para sí y 0 para no)");
        System.out.println("+---------------------------+");
        System.out.println("|       Tarjeta Nº3         |");
        System.out.println("+---------------------------+");
        ...
        System.out.println("|  20   38   50   78        |");
        System.out.println("|  21   39   61   79        |");
        System.out.println("+---------------------------+");
        }
        
        static void MostrarTarjeta4(){
            
        System.out.println("Está el número que has pensado en esta tarjeta? (1 para sí y 0 para no)");

        System.out.println("+---------------------------+");
        System.out.println("|       Tarjeta Nº4         |");
        System.out.println("+---------------------------+");
        ...
        static void MostrarTarjeta5(){
            System.out.println("Está el número que has pensado en esta tarjeta? (1 para sí y 0 para no)");
        System.out.println("+---------------------------+");
        System.out.println("|       Tarjeta Nº5         |");
        System.out.println("+---------------------------+");
        ...
        static void MostrarTarjeta6(){
            System.out.println("Está el número que has pensado en esta tarjeta? (1 para sí y 0 para no)");
        System.out.println("+---------------------------+");
        System.out.println("|       Tarjeta Nº6         |");
        System.out.println("+---------------------------+");
        ...
        static void MostrarTarjeta7(){
            System.out.println("Está el número que has pensado en esta tarjeta? (1 para sí y 0 para no)");
        System.out.println("+---------------------------+");
        System.out.println("|       Tarjeta Nº7         |");
        System.out.println("+---------------------------+");
