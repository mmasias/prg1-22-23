...
public class adivinaNumero {
    public static void main( String[] args ) {
        ...
        System.out.println("Indica las tablas en las que aparece: ");
        ...
        System.out.println("¿Ves tu numero aqui? si/no ");
        
        r1 = teclado.nextLine();
        if (r1.equals("si") ) {
            numeroAcumulado = numeroAcumulado + 1;
        }
        ...
        r2 = teclado.nextLine();
        if (r2.equals("si") ) {
            numeroAcumulado = numeroAcumulado + 2;
        }
        ...
        r3 = teclado.nextLine();
        if (r3.equals("si") ) {
            numeroAcumulado = numeroAcumulado + 4;
        }
        ...
        r4 = teclado.nextLine();
        if (r4.equals("si") ) {
            numeroAcumulado = numeroAcumulado + 8;
        }
        ...
        r5 = teclado.nextLine();
        if (r5.equals("si") ) {
            numeroAcumulado = numeroAcumulado + 16;
        }
        ...
        r6 = teclado.nextLine();
        if (r6.equals("si") ) {
            numeroAcumulado = numeroAcumulado + 32;
        }
        ...
        r7 = teclado.nextLine();
        if (r7.equals("si") ) {
            numeroAcumulado = numeroAcumulado + 64;
        }

        System.out.print("El numero es " + numeroAcumulado);
