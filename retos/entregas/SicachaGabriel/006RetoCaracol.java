public class Caracol{
    public static void main(String args[]){
        ...
        int ProfundidadCaracol = (int)(Math.random()*10)+ProfundidadPozo;
        int dia = 0;
        int subida;
        int bajada;
        int NivelAgua = -20;
        ...
        while ((ProfundidadCaracol<1) && (dia < 50)){
            ...
            ProfundidadCaracol = ProfundidadCaracol + subida - bajada;
            if (ProfundidadCaracol <= NivelAgua){
                ProfundidadCaracol = NivelAgua + 1;
            }
            if (ProfundidadCaracol <= ProfundidadPozo){
            ...
            System.out.println(" Altura al final del dia ["+ ProfundidadCaracol +"]");
        ...
        if (dia == 50){
        System.out.println("Murio el dia 50 a una profundidad de "+ ProfundidadCaracol);
        }
        }
    }
}
