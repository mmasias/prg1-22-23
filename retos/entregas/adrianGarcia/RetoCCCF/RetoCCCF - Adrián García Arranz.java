    ...
    public static void main(String[] args){
        ...
        for(int minuto = 1; minuto <= horarioTrabajo; minuto = minuto + 1) {
            ...
            if(caja1 == 0 && cola >= 1) {
				...
				System.out.println("  >  En la caja 1 atiende un item, quedan " + itemCaja1);
			} if (itemCaja1 == 0) {
                caja1 = 0;
            }
            ...
            if(caja2 == 0 && cola >= 1){
				...
				System.out.println("  >  En la caja 2 atiende un item, quedan " + itemEnCaja2);
			}if (itemEnCaja2 == 0){
                caja2 = 0;
            }
            ...
            if(caja3 == 0 && cola >= 1){
				...
				System.out.println("  >  En la caja 3 atiende un item, quedan " + itemCaja3);
			}if(itemCaja3 == 0){
                caja3 = 0;
            }
            ...
            if(caja4 == 0 && cola >= 1) {
				...
				System.out.println("  >  En la caja 4 atiende un item, quedan " + itemsCaja4 );
			}if(itemsCaja4 == 0){
                caja4 = 0;
            }
